...
namespace SUS.MvcFramework
{
    public class Host
    {
        public static async Task RunAsync(IMvcAplication aplication, int port = 80)
        {
            ...
            aplication.ConfigureServices(serviceCollection);
            aplication.Configure(routeTable);
            AutoRegisterRouts(routeTable, aplication,serviceCollection);
        ...
        private static void AutoRegisterRouts(List<Route> routeTable, IMvcAplication aplication,IServiceCollection serviceCollection)
        {
            var controllerTypes =aplication.GetType().Assembly.GetTypes()
        ...
        private static HttpResponse ExecuteAction(HttpRequest request, Type controllerType, System.Reflection.MethodInfo action, IServiceCollection serviceCollection)
        {
            ...
            var insance = serviceCollection.CreateInstance(controllerType) as Controller;
            insance.Request = request;
            ...
            var response = action.Invoke(insance, arguments.ToArray()) as HttpResponse;
                return response;
